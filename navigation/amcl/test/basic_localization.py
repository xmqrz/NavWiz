...
class TestBasicLocalization(unittest.TestCase):
    ...
    def get_pose(self):
        ...
        except (tf2.LookupException, tf2.ExtrapolationException, tf2.ConnectivityException):
            pass
    ...
    def test_basic_localization(self):
        ...
        if global_localization == 1:
            ...
            rospy.wait_for_message('amcl_pose', geometry_msgs.msg.PoseWithCovarianceStamped)
