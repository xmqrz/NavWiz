...
* Fixes gdist- and pdist_scale node paramter names (`#936 <https://github.com/ros-planning/navigation/issues/936>`_)
  ...
  Fixes `#935 <https://github.com/ros-planning/navigation/issues/935>`_
* don't include a main() function in base_local_planner library (`#969 <https://github.com/ros-planning/navigation/issues/969>`_)
...
* Contributors: David Leins, Sam Pfeiffer, Sean Yen, ipa-fez
...
* Contributors: David V. Lu!!, Jochen Sprickerhof, Jorge Santos Simón, Michael Ferguson
