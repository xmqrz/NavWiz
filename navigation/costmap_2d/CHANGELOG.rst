...
* Merge branch 'nav-improve-p3' into 'master'
  ...
  * Separate timeout value for obstacle from mark-only source and raytrace clearing source.
  * Lower costmap resolution according to config parameter.
  * Observation laser scan is converted to point cloud only on demand.
  * Refactor code.
  * Fix raytrace freespace from sensor towards point outside height threshold is ignored.
  * Add scan range data into point cloud.
  * Speckle filter to down sample neighbour adjacent scan points.
  * Raytrace freespace costmap in between 2 adjacent laser beams.
...
* Merge branch 'nav-improve-p3-dim' into 'master'
  ...
  * Fix robot radius must be multiple of map resolution to avoid rubbing obstacles.
...
1.16.16 (2023-07-31)
--------------------
* Merge branch 'inflation-layer-optimization'

  * Refactor inflation layer footprint clearing.
  * Optimize inflation layer.

* Merge branch 'obstacle-layer-optimization'

  * Add speckle filter to remove outliers in laser scan data subscribed by obstacle layer.
  * Limit the voxel layer update border to area with changes only.
  * Add dynamic reconfigure parameter to limit final obstacle range.

* Merge branch 'nav-improve'

  * Add param throttle_update_rate for laser observation in ObstacleLayer. Increase maximum obstacle timeout value.

* Merge branch 'navx-dynamic'

  * Skip deactivation of StaticLayer.
  * Add service to clear all registered obstacle.
  * Clear voxel layer after deactivation.
...
* Merge branch 'path-planner' into 'master'
  ...
  * Added parameter for allowing clearing of inflation within robot's footprint.
...
* Merge branch 'path-planner'
  ...
  * Refactor code.
  * Add decay model over distance for obstacle timeout.

* Remove obstacles after a timeout. https://github.com/ros-planning/navigation/pull/740
* Contributors: Patrick Chin, Wong Tze Lin

1.16.12 (2021-02-25)
--------------------
* Skip new subscription callback when publishing only full costmap.
* Subscribe ocg and publish costmap in png format.
...
* Contributors: Griswald Brooks, Patrick Chin
...
1.16.9 (2020-07-22)
-------------------
* Merge branch 'costmap-optimization'
  * Accept a flag to disable update thread in Costmap2DROS class.
  * Expose costmap publish function.
  * Prevent clearing unknown space when merging ObstacleLayer using updateWithMax function.
  * Drop cell from inflation list when cost is zero.
  * Add param throttle_update_rate for laser observation in ObstacleLayer.
  * Remove unnecessary robot movement check.
* Contributors: Patrick Chin
...
* fix published footprint topic name (`#947 <https://github.com/ros-planning/navigation/issues/947>`_)
  The default name of the topic will be updated in noetic
* fix usage of size_locked, fixes `#959 <https://github.com/ros-planning/navigation/issues/959>`_ (`#966 <https://github.com/ros-planning/navigation/issues/966>`_)
* [Windows][melodic] Navigation (except for map_server and amcl) Windows build bring up (`#851 <https://github.com/ros-planning/navigation/issues/851>`_)
* Merge pull request `#957 <https://github.com/ros-planning/navigation/issues/957>`_ from Blindnology/melodic-updateOrigin
  Optimize costmap_2d::updateOrigin
* Optimize costmap_2d::updateOrigin
* Contributors: Dima Dorezyuk, Michael Ferguson, Pavlo Kolomiiets, Sean Yen, Yuki Furuta
...
* Contributors: Michael Ferguson, Steven Macenski, stevemacenski
...
* Contributors: David V. Lu!!, Martin Ganeff
