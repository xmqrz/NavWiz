...
* Add frame ID to empty NavFn paths (`#964 <https://github.com/ros-planning/navigation/issues/964>`_)
  * Don't publish empty paths
  ...
  Closes `#963 <https://github.com/ros-planning/navigation/issues/963>`_
  * Publish empty paths with a valid frame
  * Fix indexing into empty plan for timestamp
* Contributors: Nick Walker, Sam Pfeiffer, Sean Yen
