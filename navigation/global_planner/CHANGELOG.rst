...
* Contributors: Noriaki Ando, Orhan G. Hafif
...
* Merge branch 'path-planner' into 'master'
  ...
  * Use goal of the lowest path cost within tolerance if target goal is blocked.
  * Add default_tolerance into dynamic reconfigure. Refine tolerance border checking.
  * Fix parameter "default_tolerance" of global_planner is ignored.
...
* Contributors: David V. Lu!!, mechatheo

1.16.9 (2020-07-22)
-------------------
* Fix negative index bug in global_planner's ForwardThenInterpolate orientation mode.
* Contributors: Patrick Chin
...
* parameter for enabling outlineMap added (`#926 <https://github.com/ros-planning/navigation/issues/926>`_)
