...
class Bartail extends Marker {
  constructor() {
    ...
    this.svg = `<svg width="200" height="80">
        ...
        <line x1="70" y1="70" x2="130" y2="70" style="stroke:rgb(0,255,0);"/>
        <line x1="100" y1="50" x2="100" y2="70" style="stroke:rgb(0,255,0);"/>
        </svg>`;
  }
}

export default Bartail;
