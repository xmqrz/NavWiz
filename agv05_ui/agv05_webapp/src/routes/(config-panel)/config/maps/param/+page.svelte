<script>
  ...
  function save(overwrite = false) {
    ...
    maps
      ...
      .then(() => {
        toastStore.trigger({
          message: maps.successUpdateParamMsg(),
          timeout: 3000,
          hoverable: true
        });
        dirty = false;
...
<ConfigLayout title="Edit map parameters" back={['Maps', maps.listUrl()]}>
  <MapParamEditorTab curMode="param" />
  {#if isOverwrite}
      ...
      <aside class="alert variant-filled-error">
        ...
        <div class="alert-message" data-toc-ignore="">
          ...
          <p>
            ...
            <a href="${maps.paramUrl()}" target="_blank" class="font-bold">changed</a>
