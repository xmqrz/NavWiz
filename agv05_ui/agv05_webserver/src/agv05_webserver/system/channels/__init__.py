...
from .laser import LaserChannel
from .live_app import LiveAppChannel
from .log import LogChannel
from .notification import NotificationChannel
from .software_update import SoftwareUpdateChannel
from .validation_data import ValidationDataChannel

logger = logging.getLogger(__name__)


class ChannelManager(object):
    channels = [LaserChannel, LogChannel, NotificationChannel, SoftwareUpdateChannel, LiveAppChannel, ValidationDataChannel]
    ...
    def add_channel(self, cls):
        ...
        if cls.id in self.channels:
            logger.error('Another channel with the same id as this channel [%s] has been registered.', cls)
            return
