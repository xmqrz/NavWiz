...
def update_feature_group(apps, schema_editor):
    ...
    change_datetime = Permission.objects.get(content_type__app_label='system', codename='change_datetime')

    group_sv.permissions.add(change_datetime)


class Migration(migrations.Migration):

    dependencies = [
        ('system', '0015_permissions'),
    ]
