# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-02-28 18:55
...
def update_feature_group(apps, schema_editor):
    ...
    change_network = Permission.objects.get(content_type__app_label='system', codename='change_network')

    group_sv.permissions.add(change_network)


class Migration(migrations.Migration):

    dependencies = [
        ('system', '0022_permissions'),
    ]
