# -*- coding: utf-8 -*-
# Generated by Django 1.11.22 on 2019-07-16 11:08
...
def update_feature_group(apps, schema_editor):
    ...
    change_license = Permission.objects.get(content_type__app_label='system', codename='change_license')

    group_sv.permissions.add(change_license)


class Migration(migrations.Migration):

    dependencies = [
        ('system', '0024_permissions'),
    ]
