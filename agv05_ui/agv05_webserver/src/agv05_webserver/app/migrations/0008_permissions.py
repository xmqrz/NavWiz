# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-03-27 07:49
...
def update_feature_group(apps, schema_editor):
    ...
    start_task_runner = Permission.objects.get(content_type__app_label='app', codename='start_task_runner')
    stop_task_runner = Permission.objects.get(content_type__app_label='app', codename='stop_task_runner')
    pause_task_runner = Permission.objects.get(content_type__app_label='app', codename='pause_task_runner')
    resume_task_runner = Permission.objects.get(content_type__app_label='app', codename='resume_task_runner')
    start_app = Permission.objects.get(content_type__app_label='app', codename='start_app')
    stop_app = Permission.objects.get(content_type__app_label='app', codename='stop_app')

    new_permissions = (start_task_runner, stop_task_runner, pause_task_runner, resume_task_runner, start_app, stop_app)
