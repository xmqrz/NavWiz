# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2020-06-02 09:06
...
def update_feature_group(apps, schema_editor):
    ...
    show_system_clock = Permission.objects.get(content_type__app_label='app', codename='show_system_clock')

    user_agv_panel.user_permissions.add(show_system_clock)
    user_agv_panel_pp.user_permissions.add(show_system_clock)

    group_anon.permissions.add(show_system_clock)
    group_cb.permissions.add(show_system_clock)
    group_user.permissions.add(show_system_clock)
    group_sv.permissions.add(show_system_clock)


class Migration(migrations.Migration):

    dependencies = [
        ('app', '0008_permissions'),
    ]
