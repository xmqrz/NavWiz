# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-02-15 13:36
...
def update_feature_group(apps, schema_editor):
    ...
    show_popup_safety = Permission.objects.get(content_type__app_label='app', codename='show_popup_safety')

    user_agv_panel.user_permissions.add(show_popup_safety)
    user_agv_panel_pp.user_permissions.add(show_popup_safety)

    group_user.permissions.add(show_popup_safety)
    group_sv.permissions.add(show_popup_safety)

    # Put in a try...except block because the permission is obsolete and might not be found.
    try:
        show_popup_user = Permission.objects.get(content_type__app_label='app', codename='show_popup_user')

        user_agv_panel.user_permissions.add(show_popup_user)
        user_agv_panel_pp.user_permissions.add(show_popup_user)

        group_user.permissions.add(show_popup_user)
        group_sv.permissions.add(show_popup_user)
    except Exception:
        pass
        ...
        migrations.AlterModelOptions(
            ...
            options={
                'permissions': (
                    ...
                    ('show_popup_user', 'Show user message popup'),
