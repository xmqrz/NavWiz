# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2023-07-10 22:40
...
def update_feature_group(apps, schema_editor):
    ...
    hot_reload = Permission.objects.get(content_type__app_label='app', codename='hot_reload')

    group_user.permissions.add(hot_reload)
    group_sv.permissions.add(hot_reload)


class Migration(migrations.Migration):

    dependencies = [
        ('app', '0010_permissions'),
    ]
